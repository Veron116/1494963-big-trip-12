...
export default class EventEdit extends Smart {
  ...
  setInnerHandlers() {
    ...
    this.getElement().querySelectorAll(`.event__type-input`).forEach((inputType) => inputType.addEventListener(`change`, this._eventTypeHandler));
  }
