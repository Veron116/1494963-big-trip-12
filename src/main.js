...
const headerElement = document.querySelector('.mjs-header');
const tripMainElement = headerElement.querySelector('.mjs-trip-main');
const tabsControlsElement = headerElement.querySelector('.mjs-tabs-controls');
...
const contentElement = document.querySelector('.mjs-content-field');
